...
func main() {
	...
	mux.HandleFunc("OPTIONS /staff/found-items/{id}", optCORS)
	...
	mux.HandleFunc("PUT /staff/found-items/{id}", corsMiddleware(staffUpdateFoundItemHandler))
	mux.HandleFunc("DELETE /staff/found-items/{id}", corsMiddleware(staffDeleteFoundItemHandler))
